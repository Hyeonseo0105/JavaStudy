 ...
 *                          -------- 모든 클래스는 생성자를 가지고 있다
 *        --------------------------
 *         재사용 / 데이터 변질,손질 / 변경이 쉽게... (객체지향) => 유지보수
 *         ----   ------------  ---------
 *          |          |            |
...
import java.awt.*;
// 오버라이딩(재정의) => 기본(상속) => 속도(상속 (X)) => 익명의 클래스를 이용하면 재정의
public class MainClass2 extends JFrame{
	...
	public MainClass2()
	{
		...
		//배치
		add("Center",js);
		String[] data= {"1","김철","남자","서울","011-2344-0909"};
		for(int i=0;i<10;i++)
		{
			model.addRow(data);
		}
