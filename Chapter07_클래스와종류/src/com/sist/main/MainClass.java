 ...
 *             2) 재사용 기법 : 상속 => 기존의 클래스를 확장 , 필요시에 변경해서 사용                           
 *                            class A
 *                            class B extends A
 ...
 *    }
 *    
 *    A a=new B();  ==> 추상클래스 / 인트페이스
 *    --- a.display
 *    B b=new B();  ==> 확장된 클래스(거의 이렇게 사용)
 *    --- a,b,aaa(),display()
 *    //상위클래스로 받지마라
 */
public class MainClass {
	...
	public static void main(String[] args) {
		...
		List names=new ArrayList();   //컬렉션 => 배열 대신 사용
		names.add("김철"); //0
		//String name=(String)names.get(0);   //형변환 시키는게 기본
		Object name=names.get(0);             //name. => object로 받을 수 있는거만
	}
