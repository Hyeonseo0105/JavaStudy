 ...
 *           -------------------------
 *              구현이 된 메소드 (구현:default,static만 가능)
 *              default void aaa() {
 *                 
 *              }
 ...
 *                 }
 *                 ==> public void aaa();
 *                 ==> public default bbb(){}    //생략가능한데 감못잡으면 public써주기
 *           -------------------------
 ...
 *         interface =====> interface
 *         interface A
 *         interface B (extends) A      //인터페이스끼리는 extends
 *                      -------
 *         interface =====> class
 *         interface A
...
//interface A
//{
//	private int a=10; //변수도 public이어야 하니까 private쓰면 오류
//	void disp();
//}
//class B implements A
//{
//	void disp() {} //일반클래스(확대)는 public생략못함
//	
//}
import javax.swing.*;
import java.awt.event.*;
public class MainClass_3 extends JFrame implements ActionListener,MouseListener,KeyListener{   //윈도우 상속
