...
public class SiteMain {
	...
	public static void main(String[] args) {
		...
		Map map=new HashMap();  //Map<String,Controller> map=new HashMap<String,Controller>; ==> 제네릭스
		...
		while(true)
		{
			...
			Controller c=(Controller)map.get("c"+menu); //Controller c=map.get("c"+menu);
			c.execute();
//			if(menu==1)
//			{
