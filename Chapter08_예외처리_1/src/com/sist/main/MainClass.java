 ...
 *        {
 *           void aaa();  ---
 *           void bbb();     |  무조건 구현해야하는 부분 
 *           void ccc();  ---
 *           void default ddd() {}  //필요하면 구현하고 아니면 X
 *           void default eee() {}
 *           void default kkk() {}
 *        }
...
{
	//private int a=10;
	//public은 생략하면 => 컴파일러에 의해 자동으로 public추가
...
// 구현(상속) ==> class(단일상속) , interface(다중상속)
{
	...
	{
		//display();
		I.display();//인터페이스의 static메서드 => 인터페이스명으로만 접근이 가능
	}
}
interface AA
{
