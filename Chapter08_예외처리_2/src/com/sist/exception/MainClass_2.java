 ...
 *                    문장3
 *                     |    int[] arr=new int[2];
 *                          arr[2]=Integer.paraseInt("10");
 *                                 ------------------------
 *                 }catch(A) else if
 *                 {
 *                    A에 대한 에러 복구 => finally이동
 *                 }     |
 *                 catch(B) else if
 *                 {
 *                    B에 대한 에러 복구 => finally이동
 *                 }     |
 *                 catch(C) else if
 *                 {
 *                    C에 대한 에러 복구
...
public class MainClass_2 {
	...
	public static void main(String[] args) {
		...
		//FileReader fr=new FileReader("c:\\JavaDev\\movie.txt"); => 오류
		//파일읽기 2가지 1.:1byte씩 읽어줌 2.FileReader:2byte씩 읽어줌
		FileReader fr=null;
		try
		{
			fr=new FileReader("c:\\JavaDev\\movie.txt");
			//String data="";  //Ajax
			StringBuffer sb=new StringBuffer();   //속도빠름
			int i=0;
			while((i=fr.read())!=-1)
			{
				//data+=(char)i;
