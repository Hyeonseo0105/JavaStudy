...
public class StudentManager {
	...
	{
		list.add(new Student(1, "황미애", 100, 80, 70));
		list.add(new Student(2, "김철", 90, 95, 65));
		list.add(new Student(3, "모지섭", 50, 60, 70));
		list.add(new Student(4, "서지수", 100, 100, 100));
		list.add(new Student(5, "김송이", 95, 100, 90));
	}
	...
	{
		for(int i=0;i<list.size();i++)    //인덱스번호필요함 ∴for문(O) for-each구문(X)
		{
			Student s=list.get(i);
