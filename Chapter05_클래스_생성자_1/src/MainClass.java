 ...
 *      }
 *      
 *      A => SawonSystem s=new SaonSystem();
 *            sawons[1]=A
 *      B => SawonSystem s=new SaonSystem();
 *            sawons[1]=A
 *      C => SawonSystem s=new SaonSystem();
 *            sawons[1]=A
 *            
 ...
 *                매개변수가 있는 경우도 생성자다
 */
// package / import => new MainClass()  두개만 class위에 사용 가능
class Sawon{
	int sabun;
	String name;
	String dept,job,loc;
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Sawon sa2=new Sawon(2,"마크","영업부","과장","경기");
